...
const About = () => {
    return (
        <>
            ...
            <p className="content">One of his best projects so far has been StationBot, a Discord.JS (v12) bot made because he wanted to try and make something new and something that will help him on his javascript/typescript journey. To learn more about the bot <a href="https://github.com/stationarystation/stationbot">click here</a>.</p>
        </>
    );
}
