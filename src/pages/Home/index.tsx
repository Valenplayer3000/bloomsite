    ...
    return (
        <>
            ...
            <div className="post-container">
                ...
                <p className="content">I was a little bit behind the competition on the Jumping Jacks but absolutely <a className="bold">dominated</a> the competition on the pushups.</p>
                <p className="content">After that, the results came in and I got 1st place on the B1 category with a whopping <a className="bold">69</a> (nice number btw) repetitions! Most of those repetitions were from the pushups because I was doing them so fast that I stopped counting.</p>
